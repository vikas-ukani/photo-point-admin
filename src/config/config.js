...
export const ShipOrderAPICollection = {
  // shiporder-login
  login: { method: "POST", url: api_prefix + "shiporder-login" },

  // login: {
  //   method: "POST", url: "https://apiv2.shiprocket.in/v1/external/auth/login", headers: { headers: { "Content-Type": "application/json" } }
  // },
